                ...
                <div id="products">
                    ...
                    <div style="width:900px;height:auto;background:#f5f5f5; border-radius:5px;">
                        ...
                        <p id="confirmationText">
                            <strong>Hi Udoh,</strong><br><br>
                            Your order has been successfully processed and will be delivered within 24 hours.<br>
                            Please keep a note of your confirmation number:<strong>${orderRecord.confirmationNumber}</strong><br>
                            If you have a query concerning your order, feel free to contact us.<br><br>
                        ...
                        <table style="text-align:center;width:100%;">
                            ...
                            <tr style="height:40px;font-size:16px;font-weight:bold;"><td colspan="3">SUB-TOTAL:</td><td align="center">$${cart.subtotal}</td></tr>
                            <tr style="height:40px;font-size:16px;font-weight:bold;"><td colspan="3">FLAT SHIPPING RATE:</td><td align="center">$20.00</td></tr>
                            <tr style="height:40px;font-size:18px;font-weight:bold;"><td colspan="3">TOTAL:</td><td align="center">$${cart.total}</td></tr>
                        </table>
                        <div class="cl">&nbsp;</div>
                        <br>
                        ...
                        <div style="font-size:16px;"> 
                            <strong>&nbsp;Delivery Address:</strong> &nbsp;No 67 sandy lane
                        </div>
                        <br>
                        <div style="font-size:16px;"> 
                            <strong>&nbsp;Postal Code:</strong> &nbsp;No 67 sandy lane
                        </div>
                        <br>
                        <div style="font-size:16px;"> 
                            <strong>&nbsp;Email Address:</strong> &nbsp;No 67 sandy lane
                        </div>
                        <br>
                        <div style="font-size:16px;"> 
                            <strong>&nbsp;Phone Number:</strong> &nbsp;No 67 sandy lane
                        </div>
                        <br>
                     </div>
                 </div>
